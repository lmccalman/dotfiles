# Generated by Powerlevel10k configuration wizard on 2020-08-15 at 20:30 AEST.
...
() {
  ...
  # )
  typeset -g POWERLEVEL9K_CUSTOM_DDATE="ddate +%H"
  typeset -g POWERLEVEL9K_CUSTOM_DDATE_BACKGROUND="blue"
  typeset -g POWERLEVEL9K_CUSTOM_DDATE_FOREGROUND="yellow"
